...
const envSchema = z.object({
  ...
  GARMIN_API_BASE_URL: z.string().url().default('https://apis.garmin.com/wellness-api/rest'),
  GARMIN_SYNC_ENDPOINTS: z.string().optional().default(''),
  GARMIN_WEBHOOK_SECRET: z.string().optional().default(''),
